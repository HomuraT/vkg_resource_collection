...
WHERE {
    { 
       ...
       ?product rdfs:label ?label .
       ?product bsbm:productFeature <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/ProductFeature${1:productfeatureproduct.productFeature}> .
	   ?product bsbm:productFeature <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/ProductFeature${3:productfeatureproduct.productFeature}> .
       ?product bsbm:productPropertyTextual1 ?propertyTextual .
	   ?product bsbm:productPropertyNumeric2 ?p2 .
	   FILTER ( ?p2> ${1:product.propertyNum2} ) 
    } 
}
ORDER BY ?label
OFFSET 5